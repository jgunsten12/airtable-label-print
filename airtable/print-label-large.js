/*
 * Shawnee Merchandise — Print Label (2.25" × 1.25")
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .meta .price { flex: 0 0 auto; font-weight: 700; white-space: nowrap; font-size: 10.5pt; }
...
output.markdown(
  `**${name || "Catalog item"}** (2.25" × 1.25", ${qtyLabel})\n\n` +
